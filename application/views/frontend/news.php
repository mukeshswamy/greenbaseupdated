		...
		<div class="row">
			...
			<div class="col-md-10 pad0 desktop-main-news-section" id="latest">
				<div class="latest-news-div" id="latestNews">
					<!-- <div class="latest-left-content">
						<img src=<?php echo base_url('assets/images/resume.jpg'); ?> alt="latest" class="latest-img">
					</div>
			...
			<div class="col-md-10 pad0 desktop-main-news-section">
				...
				<div class="row cus-row" id="related">
					<!-- <div class="col-md-6 cus-col6 left-related-div padding-right" id="pressrelease">
						<div class="related-div-img">
							<img src=<?php echo base_url('assets/images/related_news.jpg'); ?> alt="related" class="related-img">
						</div>
			...
			<div class="mobile-main-news-section">
				...
				<div class="news-card-wrapper " id="latestMobileNews">
					<!-- <div class="news-img-wrapper">
						<img src=<?php echo base_url('assets/images/resume.jpg'); ?> alt="newsimg" class="news-img">
					</div>
				...
				<div class="news-card-wrapper" id="relatedMobile">
					<div class="news-img-wrapper">
						<img src=<?php echo base_url('assets/images/related_news.jpg'); ?> alt="newsimg" class="news-img">
					</div>
					<div class="news-detail-wrapper">
						<div class="latest-news-content-div">
