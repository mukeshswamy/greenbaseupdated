<section class="section-1-about banner-main setMaxWidth">
    <div class="banner-about banner-slider-container">
        <img src=<?php echo base_url('assets/images/about/legacy_banner.jpg') ?> alt="banner_in_about" class="banner_about_img">
        ...
        <div class="group_content content_bg d-flex mt-4">
            ...
            <div class="stats_detail_wrapper bg-col-1 flex-1 d-flex flex-column">
                ...
                <div class="stats_images_wrapper flex-1">
                    <img src=<?php echo base_url('assets/images/about/overview_bg.png') ?> alt="overflow_bg" class="overflow_bg">
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="real_estate_img_wrapper">
                                <img src=<?php echo base_url('assets/images/about/residential.svg') ?> alt="ico" class="residential_img">
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 pad0 mt-35">
                            <div class="oil_img_wrapper relative">
                                <img src=<?php echo base_url('assets/images/about/lng_li.svg') ?> alt="ico" class="oil_img">
                            </div>
                            <h5 class="m-0 lato-bold">LNG Liquefaction</h5>
                        </div>
                        <div class="col-md-12 pad0 mt-35">
                            <div class="oil_img_wrapper relative">
                                <img src=<?php echo base_url('assets/images/about/market.svg') ?> alt="ico" class="oil_img">
                            </div>
                            <h5 class="m-0 lato-bold">Marketing and Distribution</h5>
                        </div>
                        <div class="col-md-12 pad0 mt-35">
                            <div class="oil_img_wrapper relative">
                                <img src=<?php echo base_url('assets/images/about/lng_re.svg') ?> alt="ico" class="width-95">
                            </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="infra_estate_img_wrapper real_estate_img_wrapper">
                            <img src=<?php echo base_url('assets/images/about/industry.svg') ?> alt="ico" class="width-55 relative top-5">
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="real_estate_img_wrapper infra_estate_img_wrapper">
                            <img src=<?php echo base_url('assets/images/about/city.svg') ?> alt="ico" class="width-140 relative top-10">
                        </div>
