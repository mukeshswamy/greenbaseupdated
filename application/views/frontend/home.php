...
<section class="banner-main">
			...
			<div class="carousel-inner">
				...
				<div class="carousel-item banner-sliders">
					...
					<div class="banner-caption-container m-home-caption">
						...
						<div class="banner-caption">
							Pan-India land bank at high-potential location in close proximity to commercial,logistical
							and freight corridors.
						</div>
					</div>
					<div class="banner-brand-name">
						<p>A Hiranandani Group - Blackstone JV</p>
					</div>
				</div>
				<div class="carousel-item banner-sliders">
					...
					<div class="banner-caption-container m-home-caption">
						...
						<div class="banner-caption">
							Our expertise as infrastructure real estate developers, provide the necessary proficiency in
							creating world-class industrial and supply chain businesses.
						</div>
					</div>
					<div class="banner-brand-name">
						<p>A Hiranandani Group - Blackstone JV</p>
	...
	<div class="company-stats-container py-5 -m-mb-2rem">
		...
		<div class="company-stats">
			<h1>14.1 mn sq.ft</h1>
			<small>land under development</small>
		</div>
		<div class="company-stats">
			<h1>$500 mn+</h1>
			<small>planned investment</small>
		</div>
		<div class="company-stats">
			<h1>24</h1>
			<small>locations(PAN - India)</small>
		</div>
		<div class="company-stats">
			<h1>1600</h1>
